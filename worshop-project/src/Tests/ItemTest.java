...
public class ItemTest {
    ...
    @Test
    void testBadUpdateRating() {
        item.updateRating(4.5); // Update the rating with a new value but no orders yet
        assertEquals(0.0, item.getRating(), 0.01); // Check if the rating is updated correctly
    }
    @Test
    void testBuyItem() {
